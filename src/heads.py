...
def build_classification_head(model, dataset_names, data_location, device):
    weights = []
    for dataset_name in dataset_names:
        ...
        with torch.no_grad():
            ...
            weights.append(zeroshot_weights)
...
def get_classification_head(args, dataset):
    ...
    filename = os.path.join(args.save, f'head_{dataset_str}.pt')
